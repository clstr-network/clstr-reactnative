...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: fontSize.xl, fontWeight: '600', fontFamily: fontFamily.semiBold },
  ...
  name: { fontSize: fontSize['3xl'], fontWeight: '800', marginTop: 8, fontFamily: fontFamily.extraBold },
  ...
  statNum: { fontSize: fontSize.xl, fontWeight: '800', fontFamily: fontFamily.extraBold },
  ...
  socialLinkLabel: { fontSize: fontSize.md, fontWeight: '500', fontFamily: fontFamily.semiBold },
  portfolioBanner: {
    flexDirection: 'row', alignItems: 'center', gap: 12,
    marginHorizontal: 16, marginTop: 16,
    padding: 14, borderRadius: 12, borderWidth: 1,
  },
  portfolioTitle: { fontSize: fontSize.body, fontWeight: '700', fontFamily: fontFamily.bold },
  portfolioSubtitle: { fontSize: fontSize.sm, fontFamily: fontFamily.regular, marginTop: 2 },
  completionBanner: {
  ...
  menuLabel: { flex: 1, fontSize: fontSize.body, fontWeight: '600', fontFamily: fontFamily.semiBold },
  ...
  tabBtnText: { fontSize: fontSize.base, fontWeight: '600', fontFamily: fontFamily.semiBold },
  tabContent: { minHeight: 200, paddingHorizontal: 16, paddingTop: 12 },
  tabEmpty: { alignItems: 'center', paddingVertical: 40, gap: 10 },
  tabEmptyText: { fontSize: fontSize.body, fontFamily: fontFamily.regular },
  tabEmptyBtn: { paddingHorizontal: 20, paddingVertical: 10, borderRadius: 10, marginTop: 6 },
  tabEmptyBtnText: { color: '#fff', fontSize: fontSize.base, fontWeight: '600', fontFamily: fontFamily.semiBold },
  /* ─── About section ────────────────────────────────────── */
  aboutSection: { gap: 20 },
  aboutBlock: { gap: 8 },
  aboutBlockHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4 },
  aboutBlockTitle: { fontSize: fontSize.lg, fontWeight: '700', fontFamily: fontFamily.bold },
  aboutEmpty: { fontSize: fontSize.md, fontFamily: fontFamily.regular, marginLeft: 28 },
  aboutEntry: { marginLeft: 28, paddingBottom: 10, borderBottomWidth: StyleSheet.hairlineWidth, gap: 2 },
  aboutEntryTitle: { fontSize: fontSize.body, fontWeight: '600', fontFamily: fontFamily.semiBold },
  aboutEntrySubtitle: { fontSize: fontSize.md, fontFamily: fontFamily.regular },
  aboutEntryDate: { fontSize: fontSize.sm, fontFamily: fontFamily.regular },
  aboutEntryDesc: { fontSize: fontSize.md, fontFamily: fontFamily.regular, marginTop: 4, lineHeight: 19 },
  ...
  skillChipText: { fontSize: fontSize.md, fontWeight: '600', fontFamily: fontFamily.semiBold },
  ...
  projectTitle: { flex: 1, fontSize: fontSize.body, fontWeight: '700', fontFamily: fontFamily.bold },
  projectStatus: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  projectStatusText: { fontSize: fontSize.xs, fontWeight: '600', fontFamily: fontFamily.semiBold, textTransform: 'capitalize' },
  projectDesc: { fontSize: fontSize.md, fontFamily: fontFamily.regular, marginTop: 6, lineHeight: 19 },
  ...
  techChipText: { fontSize: fontSize.xs, fontWeight: '500', fontFamily: fontFamily.medium },
  techMore: { fontSize: fontSize.xs, fontFamily: fontFamily.regular, alignSelf: 'center' },
});
