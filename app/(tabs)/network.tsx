...
const styles = StyleSheet.create({
  ...
  title: { fontSize: fontSize['4xl'], fontWeight: '800', paddingHorizontal: 16, marginBottom: 12, fontFamily: fontFamily.extraBold },
  ...
  searchInput: { flex: 1, marginLeft: 8, fontSize: fontSize.body, fontFamily: fontFamily.regular, padding: 0 },
  ...
  searchAvatarText: { fontSize: fontSize.lg, fontWeight: '700', fontFamily: fontFamily.bold },
  searchResultInfo: { flex: 1, marginLeft: 12 },
  searchResultName: { fontSize: fontSize.body, fontWeight: '600', fontFamily: fontFamily.semiBold },
  searchResultHeadline: { fontSize: fontSize.md, marginTop: 2, fontFamily: fontFamily.regular },
});
