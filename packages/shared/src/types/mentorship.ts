...
export const MENTORSHIP_QUERY_KEYS = {
  ...
  profileOffer: (userId: string) => ['mentorship', 'profile-offer', userId] as const,
} as const;
...
/**
 * Compute soft highlights for a mentor based on DB-persisted offer data.
 * These are NOT ratings — they're credibility signals.
 */
