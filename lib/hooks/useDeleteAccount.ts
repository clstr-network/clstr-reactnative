/**
 * useDeleteAccount — Hook to deactivate the current user's account.
 *
 * Wraps `deactivateOwnAccount` from lib/api/account.ts.
 * On success: clears query cache + signs out locally.
 * 15-day grace period before permanent deletion (server-side).
 */
